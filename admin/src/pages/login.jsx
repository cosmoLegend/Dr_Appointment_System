    ...
    return (
        <form onSubmit = {onSubmitHandler} className='min-h-[80vh] flex items-center justify-center'>
            <div className='flex flex-col gap-3 m auto items-start p-8 min-w-[340px] sm:min-w-96 border rounded-xl text-[#5e5e5e] text-sm shadow-lg'>
                ...
                {
                    state === 'Admin'
                    ?<p>Doctor Login? <span className = 'text-primary underline cursor-pointer font-bold' onClick={()=>setState('Doctor')}>Click here</span></p>
                    :<p>Admin Login? <span className = 'text-primary underline cursor-pointer font-bold' onClick={()=>setState('Admin')}>Click here</span></p>
                }
            </div>
